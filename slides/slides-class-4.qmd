...
::: columns
::: {.column width="50%"}
![](images/folder_organization_alt.png){width="279"}
:::
...
Quarto documents ([Class 5](classes/class-5.html)) that you will use to genearate reports for exploring your data, creating data visualizations, and conduct statistical analyses
