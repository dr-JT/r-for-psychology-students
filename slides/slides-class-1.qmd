...
-   **The scratchpad script file**: A script file for testing, debugging, and exploring your data.
...
Go ahead and type the following two lines of code in your scratchpad script file and execute the lines of code.
...
-   Installing the package just installs it on your computer
...
::: nonincremental
-   Let's create a new script - a reproducible script for the rest of this class
