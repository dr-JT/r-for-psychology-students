...
1.  Typing code in an R script file and executing R code line-by-line
...
1.  Write and execute multiple lines of R code to test something out
2.  If you need to repeatedly execute the same or similar line of R code and don't want to keep typing it out and remembering the proper syntax each time
...
In the rest of the course, we will go into greather depth on transforming data, graphical visualization, and statistical analysis. But hopefully for now this class gave you a starting foundation to working with data in R and a taste for what is possible.
