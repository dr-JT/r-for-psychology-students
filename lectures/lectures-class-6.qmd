...
In [Class 5](/lectures/lectures-class-5.html) you setup a project with a folder organization and RStudio Project file:
...
1.  Create a new R script file named: **2_score.R**
