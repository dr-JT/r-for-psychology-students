...
It is the first element that is required to create a plot:
...
Often times you may want to apply the same customized theme elements to multiple plots, or use your own theme settings across multiple projects.
