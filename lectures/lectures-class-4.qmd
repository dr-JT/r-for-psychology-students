...
[See mode details here](https://ggplot2.tidyverse.org/reference/aes_colour_fill_alpha.html){target="_blank"}
...
Then you need to specify the theme object, `plot_theme`, in `theme_set()`
