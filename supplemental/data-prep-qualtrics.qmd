...
3.  Move the downloaded data file to your **data/raw** or **data/raw/messy** folder
...
data_import <- 
  data.frame(ID = c(13, 14, 15),
             Q21.. = c("sometimes", "always", "never"),
             Q22.. = c("rarely", "often", "always"),
             Q23.. = c("sometimes", "never", "almost never"),
             SQ_S1 = c(NA, "strongly agree", "disagree"),
             SQ_S2 = c(NA, "agree", "strongly disagree"),
             SQ_P3 = c(NA, "disagree" ,"agree"))

paged_table(data_import)
```
...
paged_table(data_survey1)
paged_table(data_survey2)
```
:::
