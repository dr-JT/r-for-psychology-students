...
🛠️ Install the [latest version of Quarto](https://quarto.org/docs/download/){target="_blank"}

------------------------------------------------------------------------

[Quarto documents](https://quarto.org){target="_blank"} are a versatile way to create production quality articles, presentations, dashboards, websites, blogs, and books in HTML, PDF, MS Word, ePub, and more. In fact, this R Workshop was created using Quarto documents.
...
-   [Here is a list of all the HTML format YAML options](https://quarto.org/docs/reference/formats/html.html){target="_blank"}

-   [Here is a user guide on creating HTML output](https://quarto.org/docs/output-formats/html-basics.html){target="_blank"}
...
By default, Quarto will open a new document in the [visual editor mode](https://quarto.org/docs/visual-editor/#:~:text=To%20switch%20into%20visual%20mode,be%20preserved%20when%20you%20switch){target="_blank"}. The Quarto visual editor provides a [WYSIWYM](https://en.wikipedia.org/wiki/WYSIWYM){target="_blank"} editing interface.
...
For instance, here are some of the styling options I used in the [sample report](/sample_report.html){target="_blank"}:
