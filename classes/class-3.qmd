...
🖥️ [Slides](/slides/slides-class-3.html){target="_blank"}
...
Let's use what we learned in [Class](/classes/class-2.html){target="_blank"}[2](/lectures/lectures-class-2.html){target="_blank"} and import two data files.
...
For this activity we will work with a real data set from a paper published in Psychological Science (one of the top journals in psychology).
...
📄 [Download the paper](/data/dawtry-et-al-2015.pdf){target="_blank"} (optional)
...
1.  Download the data file
    ...
    ⬇️ <a href="/data/Dawtry Sutton and Sibley 2015 Study 1a.csv" download="Dawtry Sutton and Sibley 2015 Study 1a.csv">Dawtry Sutton and Sibley 2015 Study 1a.csv</a>

2.  Create a new R script and save it as **class3_activity_firstlastname.R**

3.  **Load** the following packages at the top of your script

    -   `readr`, `dplyr`, `gt`, `ggplot2`

4.  **Import** the data file

5.  Take some time to **explore the data**.
