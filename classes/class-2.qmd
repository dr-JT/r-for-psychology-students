---
title: "Import, Merge, and Restructure Data"
subtitle: "Class 2"
execute:
  echo: true
  eval: false
...
🖥️ [Slides](/slides/slides-class-2.html){target="_blank"}

# Prepare

Before starting this class:

📖 Read about the [Pipe Operator](/supplemental/pipe-operator.html)
...
2.  Create a new R script and save it as **class2_activity.R**

3.  Load the following packages at the top of your script

    -   `readr`, `dplyr`, `tidyr`, `ggplot2`

4.  Import the data files

5.  Get to know the data (use what you learned from [Class](/classes/class-1.html)[1](/lectures/lectures-class-1.html))
